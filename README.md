...
Finally, the README file, ipynb, and environment.yml files got pushed from locally on Syzygy to Github as following:
   ```bash
   git add README.md environment.yml week02_Ly.ipynb
   git commit -m "Upload initial Assignment 1 files: README, environment, and notebook"
   git push origin main
   ```
